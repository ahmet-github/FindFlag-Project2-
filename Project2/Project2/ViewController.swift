...
//  Project2
//
//  Created by Ahmet İyidoğan on 7/23/22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        let finalAc = UIAlertController(title: "Game Finished!", message: "Your final score is \(score) ", preferredStyle: .alert)
        
        finalAc.addAction(UIAlertAction(title: "OK", style: .default, handler: askQuestion))
